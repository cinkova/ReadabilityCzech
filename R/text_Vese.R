#' @name text_Vese
#' @title text_Vese
#' @description A Czech text converted to conll-u data frame
#' @format 
...
#' @source #' A data frame that was obtained by parsing plain text with UDPipe. The UDPipe parser outputs a file in the CONLL-U format. Use J. Wijffels' udpipe package to parse your plain text and to convert the resulting CONLL-U format to a data frame. This data frame contains the parse of a Czech administrative text.   
#' 
